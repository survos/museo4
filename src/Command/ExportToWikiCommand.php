...
class ExportToWikiCommand extends Command
{
    protected static $defaultName = 'app:export-to-wiki';
    private $phpWord;
    private $reader;
    private $io;
    private $em;
    ...
    {
        $this
            ->setDescription('Export Database to Wiki')
...
// check if there are any search results
        ...
        foreach ($finder as $file) {
            ...
            */
            ...
            $pageContent = $this->twig->render("exhibitPage.wiki.twig", [
                'exhibit' => $exhibit,
                'page' => $page
            ]);
